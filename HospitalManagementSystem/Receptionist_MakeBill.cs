...
{
    public partial class Receptionist_MakeBill : OfficeForm
    {
        ...
        private void Receptionist_MakeBill_Load(object sender, EventArgs e)
        {
            this.Enabled = false;
        ...
        private void refresh()
        {
            ...
            //Patients Combos
            comboBoxEx1.DataSource = patBL.Read().Where(a => a.ReceptionistId == recId).Select(a => new { a.Id, a.Name }).ToList();
            comboBoxEx1.DisplayMember = "Name";
            comboBoxEx1.ValueMember = "Id";
            comboBoxEx4.DataSource = patBL.Read().Where(a => a.ReceptionistId == recId).Select(a => new { a.Id, a.Name }).ToList();
            comboBoxEx4.DisplayMember = "Name";
            comboBoxEx4.ValueMember = "Id";

            //Receptionist Combos
            comboBoxEx2.DataSource = recBL.Read().Select(a => new { a.Id, a.Name }).Where(a => a.Id == recId).ToList();
