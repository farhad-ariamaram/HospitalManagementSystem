...
{
    public partial class Manager_PtntMngmnt : OfficeForm
    {
        PatientBL BL;
        DoctorBL DocBL;
        RoomBL RooBL;
        ...
        private void Manager_PtntMngmnt_Load(object sender, EventArgs e)
        {
            this.Enabled = false;
        ...
        private void refresh()
        {
            ...
            comboBoxEx6.DataSource = RecBL.Read().Select(a => new { a.Id, a.Name }).ToList();
